...
class LateralPlanner():
  ...
  def publish(self, sm, pm):
    ...
    plan_send.lateralPlan.laneOffset = self.LP.lane_offset.offset
    plan_send.lateralPlan.laneWidthMeanLeftAdjacent = self.LP.lane_offset._lane_width_mean_left_adjacent
